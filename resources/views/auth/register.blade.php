                ...
                <div class="register-form">
                    <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control form-control_gray @error('name') is-invalid @enderror" value="{{ old('name') }}" name="name" required="" autocomplete="name"
                                autofocus="">
                        ...
                        <div class="pb-3"></div>
                        <div class="form-floating mb-3">
                            <input value="{{ old('email') }}" id="email" type="email" class="form-control form-control_gray @error('email') is-invalid @enderror" name="email" required=""
                                autocomplete="email">
                        ...
                        <div class="form-floating mb-3">
                            <input value="{{ old('mobile') }}" id="mobile" type="text" class="form-control form-control_gray @error('mobile') is-invalid @enderror" name="mobile"
                        ...
                        <div class="form-floating mb-3">
                            <input id="password" type="password" class="form-control form-control_gray @error('password') is-invalid @enderror" name="password" required="" value="{{ old('password') }}"
                        ...
                        <div class="form-floating mb-3">
                            <input value="{{ old('password_confirmation') }}" id="password-confirm" type="password" class="form-control form-control_gray @error('password_confirmation') is-invalid @enderror"
